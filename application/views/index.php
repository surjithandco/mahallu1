                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse navbar-right">
                        <ul class="nav navbar-nav">
                            <li class="active"><a href="<?php echo site_url('Welcome/nav/index'); ?>">Home</a></li>
                            <li><a href="<?php echo site_url('Welcome/nav/about-us'); ?>">About Us</a></li>
                            <!--<li><a href="<?php echo site_url('Welcome/nav/prayers'); ?>">Prayers</a></li>-->
                            <li><a href="<?php echo site_url('Welcome/nav/portfolio'); ?>">Portfolio</a></li>
                            <li class="dropdown">
                ...
                <div class="modal fade" id="login-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="loginmodal-container">
                            <h1 style="color: black;">Login to Your Account</h1><br>
                            <?php echo form_open('registeration/check_login'); ?>
                            ...
                            <div class="login-help">
                                <a href="<?php echo site_url('Welcome/nav/register'); ?>">Register</a> - <a href="#">Forgot Password</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <section id="recent-works">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-4 col-md-3">
                        <div class="recent-work-wrap">
                            <img class="img-responsive" src="<?php base_url('assets/images/portfolio/recent/item7.png');?>" alt="">
                            <div class="overlay">
                                <div class="recent-work-inner">
                                    <h3><a href="#">Event Title </a></h3>
                                    <p>There are many variations of passages of Lorem Ipsum available, but the majority</p>
                    ...
                    <div class="col-xs-12 col-sm-4 col-md-3">
                        <div class="recent-work-wrap">
                            <img class="img-responsive" src="<?php base_url('assets/images/portfolio/recent/item8.png');?>" alt="">
                            <div class="overlay">
                                <div class="recent-work-inner">
                                    <h3><a href="#">Event Title </a></h3>
                                    <p>There are many variations of passages of Lorem Ipsum available, but the majority</p>
                                    <a class="preview" href="<?php base_url('assets/images/portfolio/full/item8.png');?>" rel="prettyPhoto"><i class="fa fa-eye"></i> View</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-sm-8">
                        <div class="media contact-info wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="600ms">
                            <div class="pull-left">
                                <img class="img-responsive" src="<?php echo base_url('assets/images/service/phone.png');?>" width="60" height="60" alt="Phone">
                            </div>
                            <div class="media-body">
